...
pAI <- ggnet2(net, label = levels[color_vec != "Other"], color = "color",  legend.position = "none", mode = "fruchtermanreingold",
...
cowplot::ggsave2(pAI, file = paste0("../output/string/String_RAPnetwork-update29June2020.pdf"), width = 4, height = 3.5)
...
pDrug <- ggnet2(net, label = druggable, color = "drug_target",  legend.position = "none", mode = "fruchtermanreingold",
              ...
              label.size = 2) +  guides( size = FALSE)
cowplot::ggsave2(pDrug, file = paste0("../output/string/String_RAPnetwork_drugTargets.pdf"), width = 4, height = 3.5)
...
p_rb <-  ggnet2(net, label = rb, color = "rb",  legend.position = "none", mode = "fruchtermanreingold",
                ...
                palette = c("FALSE" = "grey", "TRUE" = "firebrick"),
                label.size = 2) +  guides( size = FALSE)
cowplot::ggsave2(p_rb, file = "../output/string/network_rb.pdf", width = 4, height = 3)
...
p_vs <-  ggnet2(net, label = vs, color = "vs",  legend.position = "none", mode = "fruchtermanreingold",
                ...
                palette = c("FALSE" = "grey", "TRUE" = "firebrick"),
                label.size = 2) +  guides( size = FALSE)
cowplot::ggsave2(p_vs, file = "../output/string/network_vs.pdf", width = 4, height = 3)
...
p_rtv <-  ggnet2(net, label = rtv, color = "rtv",  legend.position = "none", mode = "fruchtermanreingold",
                 ...
                 palette = c("FALSE" = "grey", "TRUE" = "firebrick"),
                 label.size = 2) +  guides( size = FALSE)
cowplot::ggsave2(p_rtv, file = "../output/string/network_rtv.pdf", width = 4, height = 3)
...
p_vp <-  ggnet2(net, label = vp, color = "vp",  legend.position = "none", mode = "fruchtermanreingold",
                ...
                palette = c("FALSE" = "grey", "TRUE" = "firebrick"),
                label.size = 2) +  guides( size = FALSE)
cowplot::ggsave2(p_vp, file = "../output/string/network_vb.pdf", width = 4, height = 3)
