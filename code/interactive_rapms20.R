...
#' 
#' 
#' Genes associated with ribosomal proteins are shown in blue while other genes previous associated with viral RNA are shown in purple Other significant genes at an adj. P < 0.2 are shown in grey from the RAP-MS experiment.
...
visNetwork( nodes_df, edges_df) %>% 
  ...
  visGroups(groupname = "RP", color = "#104e8b") %>%
  visGroups(groupname = "Viral-associated", color = "#912cee") %>%
